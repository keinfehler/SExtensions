...
{
    [ComVisible(true)]
    [Guid("c673e93e-29e6-4d07-b809-0952b5759f83")] // Must be unique!
    [ProgId("SExtensions")] // Must be unique!
    public class SExtensions : SolidEdgeCommunity.AddIn.SolidEdgeAddIn, // Solid Edge Community provided base class.
        ...
        ISEShortCutMenuEvents // Solid Edge Shortcut Menu Events
    {
        ...
        static void OnRegister(Type t)
        {
            ...
            try
            {
                ...
                settings.Titles.Add(englishCulture, "SExtensions");
