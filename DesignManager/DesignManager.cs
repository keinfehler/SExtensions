...
{
    [ComVisible(true)]
    [Guid("4e1bdb52-729e-453a-9741-afea0969518f")] // Must be unique!
    [ProgId("DesignManager")] // Must be unique!
    public class DesignManager : SolidEdgeCommunity.AddIn.SolidEdgeAddIn, // Solid Edge Community provided base class.
        ISEApplicationEvents,  // Solid Edge Application Events
        ISEApplicationWindowEvents, // Solid Edge Window Events
        ISEFeatureLibraryEvents, // Solid Edge Feature Library Events
        ISEFileUIEvents, // Solid Egde File UI Events
        ISENewFileUIEvents, // Solid Egde New File UI Events
        ISEECEvents, // Solid Edge EC Events
        ISEShortCutMenuEvents // Solid Edge Shortcut Menu Events
    {
        ...
        static void OnRegister(Type t)
        {
            ...
            try
            {
                ...
                settings.Titles.Add(englishCulture, "DesignManager");
                settings.Summaries.Add(englishCulture, "Solid Edge Extensions in .NET 4.0.");
                ...
                DesignManager.Register(settings);
            }
